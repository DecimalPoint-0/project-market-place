...
export const register = async (email,name, password, password2, contact) => {
    try {
        ...
        // Returning data and error information without logging in
        return { data, error: null };
    } catch (error) {
        // Handling errors and returning data and error information
        return {
...
export const verifyEmail = async (email, token) => {
    try {
        // Making a POST request to verify email
...
export const resendVerificationEmail = async (email) => {
    try {
        // Making a POST request to resend verification email
...
export const requestPasswordReset = async (email) => {
    try {
        // Making a POST request to request password reset
